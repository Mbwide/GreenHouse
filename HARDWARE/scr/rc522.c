...
{	 
  ...
  GPIO_PinRemapConfig(GPIO_Remap_SWJ_Disable,ENABLE);  //禁止所有SWJ----重要
	...
	GPIOB->CRL&=0XFFF00FFF;	  //PB.3 复位
	GPIOB->CRL|=0X00033000;		//PB.4 片选 推挽输出
